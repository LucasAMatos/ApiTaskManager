...
public class ProjetoService(
    IDAL _DAL,
    IUsuarioService usuarioService) : IProjetoService
{
    #region Projetos
    ...
    {
        var _usuario = usuarioService.GetUsuarioByName(projetoRequest.Usuario);
    ...
    {
        var _usuario = usuarioService.GetUsuarioByName(projetoAtualizado.Usuario);
    ...
    public Tarefa CreateTask(int idProjeto, TarefaRequest task)
    {
        ...
        var _usuario = usuarioService.GetUsuarioByName(task.UsuarioResponsavel);
        var _criadoPor = usuarioService.GetUsuarioByName(task.CriadoPor);
    ...
    public void UpdateTask(int idTarefa, TarefaUpdateRequest request)
    {
        ...
        var _AlteradoPor = usuarioService.GetUsuarioByName(request.AlteradoPor);
        ...
        if (request.UsuarioResponsavel != null) tarefa.Usuario = usuarioService.GetUsuarioByName(request.UsuarioResponsavel);
    ...
    {
        var _usuarioComentario = usuarioService.GetUsuarioByName(request.Usuario);
